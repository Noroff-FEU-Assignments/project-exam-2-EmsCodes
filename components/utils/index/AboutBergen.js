    ...
    <div className={styles.container}>
      ...
      <div className={styles.aboutContent}>
        <div>
          ...
          />
          <p>
            Bergen, historically Bjørgvin, is a city and municipality in
            Vestland county on the west coast of Norway. As of 2021, its
            population is roughly 285,900. Bergen is the second-largest city in
            Norway. The city is an international center for aquaculture,
            shipping, the offshore petroleum industry and subsea technology, and
            a national centre for higher education, media, tourism and finance.
          </p>
          <p>
            According to tradition, the city was founded in 1070 by King Olav
            Kyrre and was named Bjørgvin, ‘the green meadow among the
            mountains’. It served as Norway’s capital in the 13th century, and
            from the end of the 13th century became a bureau city of the
            Hanseatic League. (source: Wikipedia)
          </p>
          <p>
            ...
            culture and interesting urban attractions. Pick and choose of a
            great range of things to do in Bergen – all year round.
            (visitbergen.com)
          </p>
        </div>
        <div>
